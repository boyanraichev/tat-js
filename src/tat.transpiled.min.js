'use strict';var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj};var tat={modalHooks:[],modalConfirmHook:null,modalConfirmData:null,modalCloseHook:{},lang:{ok:'OK',cancel:'Cancel'},initialize:function initialize(){this.listeners();this.modalOnListener();this.cookie()},listeners:function listeners(){this.modalListener();this.toggleListener();this.tabsListener();this.tooltipListener();this.scrollToListener();this.confirmListener();this.inputListener();this.addRowsListener();this.delRowsListener()},modalListener:function modalListener(){modals=document.querySelectorAll('.js-modal');Array.from(modals).forEach(function(modal){modal.addEventListener('click',tat.modalShow)})},modalShow:function modalShow(event){event.preventDefault();var modalClicked=this;var modalID=modalClicked.dataset.modal;var modalContent=modalClicked.dataset.modalContent;if(modalContent==undefined||modalContent.length<1){var modalGet=document.getElementById(this.dataset.modalGet);if(modalGet){modalContent=modalGet.innerHTML}}
